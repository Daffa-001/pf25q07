...
public class TTTGraphics extends JFrame {
    ...
    public static final Color COLOR_GRID   = new Color(0, 0, 0);  // grid lines
    public static final Color COLOR_CROSS  = new Color(102, 255, 102);  // Red #D32D41
    public static final Color COLOR_NOUGHT = new Color(255, 255, 0); // Blue #4CB5F5
