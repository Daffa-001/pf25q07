...
public class GameMain extends JPanel {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            while (!authenticated) {
                System.out.print("Player " + (i + 1) + " Username: ");
                String username = sc.next();
                String rPass = retrievePassword(username);
                ...
                System.out.print("Player " + (i + 1) + " Password: ");
                String pass = sc.next();
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new GameMain(players[0], players[1]));
